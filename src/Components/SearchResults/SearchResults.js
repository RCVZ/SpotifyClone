      ...
      <Switch>
        <Route exact path="/search" render={(props) => (
          <>
            ...
            <ResultsTracklist key={2} {...props} loadMore={loadMore}/>
        ...
        <Route path="/search/tracks" render={(props) => <ResultsTracklist key={2} {...props} loadMore={loadMore}/> } />
